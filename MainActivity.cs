    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (IsThereAnAppToTakePictures())
            {
                ...
                BtnTakeImg = FindViewById<Button>(Resources.Id.btntakepicture);
                ImgView = FindViewById<ImageView>(Resources.Id.ImgTakeimg);
                BtnTakeImg.Click += TakeAPicture;
            }
        }

        private T FindViewById<T>(object imgTakeimg)
        {
